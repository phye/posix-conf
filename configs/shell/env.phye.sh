...
export GOPATH=~/ws/go
export PATH="$HOME/bin/scripts:/opt/homebrew/bin:$HOME/bin:$GOPATH/bin:$HOME/.cargo/bin:/snap/bin:/usr/local/go/bin:/usr/local/bin:/usr/local/opt/fzf/bin:/usr/local/opt/llvm/bin:/usr/bin:/bin:/usr/sbin:/sbin:/Library/TeX/texbin:/opt/X11/bin:/Library/Apple/usr/bin:$HOME/.fzf/bin"
